...
from code.Const import WIN_WIDTH, WIN_HEIGHT, C_WHITE, C_YELLOW, C_BLACK
...
class GameOver:
    ...
    def run(self):
        ...
        while True:
            ...
            self.menu_text(50, "Você morreu!", C_YELLOW, ((WIN_WIDTH / 2), WIN_HEIGHT / 2 - 110))
            self.menu_text(30, "Tente novamente", C_YELLOW, ((WIN_WIDTH / 2), WIN_HEIGHT / 2 - 70))
